...
def classify_image(interpreter, image, top_k=1):
  ...
  test_me=interpreter.get_tensor(output_details['index'])
  print(test_me)
  output = np.squeeze(test_me)
  print(output)
  ...
  print( output)  
  return output#[(i, output[i]) for i in ordered[:top_k]]
